            ...
            <div className="usage-instructions">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        document would remain in Un-published state.
                    </li>
                    <li>
                        <i className="bx bx-paper-plane"></i> You need to
                        'Publish' the document to be search ready for the end
                        user. You may Publish / Un-publish any document later as
                        well.
                    </li>
                    <li>
                        <i className="bx bx-paper-plane"></i> To manage
                        (publish/un-publish/archive/restore) artifacts, click
                        here or go to Manage Manage Artifacts
                    </li>
                </ul>
            </div>
        </div>
