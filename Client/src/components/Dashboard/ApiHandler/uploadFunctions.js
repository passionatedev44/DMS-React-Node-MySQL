...
export const handleEditArtifact = async (
    e,
    docId,
    tags,
    setTags,
    ...
    try {
        const response = await Axios.put(
            `${API_URL}/upload/updateDocumentMetadata/${docId}`,
            editData,
            {
                headers: {
                    Authorization: localStorage.getItem("token"),
